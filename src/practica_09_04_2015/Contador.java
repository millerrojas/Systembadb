...
public class Contador extends Administrativo {
    ...
    public Contador(int dni, int edad, String nombre, String apellidos) {
    ...
    @Override
    public void asistir() {
        System.out.println("asiste (clae hija) ");
    }

    @Override
    public void lista() {
    
        System.out.println("llama lista(clae hija)  ");
    }

    @Override
    public void reforza() {

        System.out.println("toma un reforzamiento (clae hija)  ");
